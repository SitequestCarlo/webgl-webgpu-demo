// =============================================================================
// none.wgsl – Kein Shading (WebGPU / WGSL)
//
// Gibt die Basisfarbe direkt aus – keinerlei Lichtberechnung.
// Nützlich als Referenz und zum Vergleich mit beleuchteten Modellen.
// =============================================================================
...
fn fs_main(in: VsOut) -> @location(0) vec4<f32> {
    // Nur Basisfarbe ausgeben – kein Licht, keine Schatten.
